...
export function HeroSection() {
  return (
    <div className="min-h-[85dvh] flex justify-center relative">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-[#A5DAAF]/20 via-transparent to-transparent backdrop-blur-3xl z-0"></div>
    </div>
  );
}
